...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-23 15:14:40 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.2245` | `0.2341` | `0.2133` | `+0.85%` |
| `ALGO-USDT` | `0.0932` | `0.0949` | `0.0879` | `+1.19%` |
| `ATOM-USDT` | `1.599` | `1.6135` | `1.5194` | `+1.53%` |
| `AVAX-USDT` | `7.554` | `7.659` | `7.276` | `+1.54%` |
| `BCH-USDT` | `273.24` | `283.38` | `262.91` | `-0.76%` |
| `BTC-USDT` | `77188.5` | `77752.6` | `75558` | `+0.31%` |
| `CAKE-USDT` | `1.738` | `1.762` | `1.656` | `+2.41%` |
| `DASH-USDT` | `42.3` | `44.44` | `38.42` | `+8.57%` |
| `DGB-USDT` | `0.004863` | `0.0057` | `0.00414` | `+17.46%` |
| `DOGE-USDT` | `0.09256` | `0.09535` | `0.08875` | `+3.01%` |
| `DOT-USDT` | `0.924` | `0.9391` | `0.8765` | `+0.66%` |
| `ETC-USDT` | `7.8772` | `8.0267` | `7.6278` | `+0.46%` |
| `ETH-USDT` | `2434.51` | `2484.76` | `2356.33` | `+1.10%` |
| `LINK-USDT` | `11.482` | `11.8137` | `11.0251` | `-0.56%` |
| `LTC-USDT` | `51.92` | `53.71` | `50.6` | `+0.27%` |
| `QTUM-USDT` | `0.89` | `0.89` | `0.805` | `+5.20%` |
| `RVN-USDT` | `0.00335` | `0.00344` | `0.00316` | `+0.00%` |
| `SHIB-USDT` | `0.000005453` | `0.000005579` | `0.000005199` | `+0.75%` |
| `SOL-USDT` | `95.3` | `97.28` | `91.58` | `+2.46%` |
| `TRX-USDT` | `0.3438` | `0.3457` | `0.3419` | `-0.05%` |
| `UNI-USDT` | `4.4797` | `4.6626` | `4.0129` | `+6.68%` |
| `XLM-USDT` | `0.1986` | `0.202` | `0.1878` | `+2.42%` |
| `XMR-USDT` | `419.44` | `442.74` | `413.5` | `+0.09%` |
| `XRP-USDT` | `1.5` | `1.55079` | `1.42955` | `+4.39%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-23 15:14:40 UTC"
}
```
