...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-23 21:43:16 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.2275` | `0.2304` | `0.2133` | `+1.15%` |
| `ALGO-USDT` | `0.0941` | `0.0949` | `0.0879` | `+2.50%` |
| `ATOM-USDT` | `1.612` | `1.6222` | `1.5194` | `+2.77%` |
| `AVAX-USDT` | `7.619` | `7.675` | `7.276` | `+2.04%` |
| `BCH-USDT` | `275.22` | `280.16` | `262.91` | `+0.50%` |
| `BTC-USDT` | `77613.1` | `78054.6` | `75558` | `+0.90%` |
| `CAKE-USDT` | `1.76` | `1.771` | `1.656` | `+3.40%` |
| `DASH-USDT` | `42.87` | `43.76` | `38.42` | `+5.69%` |
| `DGB-USDT` | `0.005019` | `0.0057` | `0.004224` | `+15.11%` |
| `DOGE-USDT` | `0.09342` | `0.09481` | `0.08875` | `+1.06%` |
| `DOT-USDT` | `0.9304` | `0.9368` | `0.8765` | `+2.15%` |
| `ETC-USDT` | `7.9794` | `8.0316` | `7.6278` | `+1.96%` |
| `ETH-USDT` | `2462.61` | `2484.76` | `2356.33` | `+2.07%` |
| `LINK-USDT` | `11.6014` | `11.9608` | `11.0251` | `+0.75%` |
| `LTC-USDT` | `52.58` | `53.19` | `50.6` | `+0.86%` |
| `QTUM-USDT` | `0.891` | `0.901` | `0.805` | `+4.33%` |
| `RVN-USDT` | `0.00341` | `0.00344` | `0.00316` | `+4.60%` |
| `SHIB-USDT` | `0.000005557` | `0.000005598` | `0.000005199` | `+2.43%` |
| `SOL-USDT` | `95.22` | `97.28` | `91.58` | `+2.23%` |
| `TRX-USDT` | `0.3442` | `0.3457` | `0.3419` | `-0.20%` |
| `UNI-USDT` | `4.6321` | `4.7066` | `4.0129` | `+8.69%` |
| `XLM-USDT` | `0.2002` | `0.2021` | `0.1878` | `+2.98%` |
| `XMR-USDT` | `428.8` | `442.74` | `413.51` | `+0.34%` |
| `XRP-USDT` | `1.51943` | `1.55079` | `1.43457` | `+4.51%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-23 21:43:16 UTC"
}
```
