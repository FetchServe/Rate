...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-23 21:14:20 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.2278` | `0.2304` | `0.2133` | `+0.08%` |
| `ALGO-USDT` | `0.0939` | `0.0949` | `0.0879` | `+1.29%` |
| `ATOM-USDT` | `1.6183` | `1.6202` | `1.5194` | `+2.48%` |
| `AVAX-USDT` | `7.626` | `7.659` | `7.276` | `+1.57%` |
| `BCH-USDT` | `276.35` | `280.16` | `262.91` | `+0.19%` |
| `BTC-USDT` | `77670.6` | `77752.6` | `75558` | `+0.78%` |
| `CAKE-USDT` | `1.76` | `1.762` | `1.656` | `+2.80%` |
| `DASH-USDT` | `43.51` | `43.76` | `38.42` | `+5.81%` |
| `DGB-USDT` | `0.005013` | `0.0057` | `0.004224` | `+16.25%` |
| `DOGE-USDT` | `0.09372` | `0.09481` | `0.08875` | `+0.03%` |
| `DOT-USDT` | `0.928` | `0.9368` | `0.8765` | `+0.41%` |
| `ETC-USDT` | `7.9901` | `8.0267` | `7.6278` | `+1.79%` |
| `ETH-USDT` | `2464.76` | `2484.76` | `2356.33` | `+2.00%` |
| `LINK-USDT` | `11.6135` | `11.7462` | `11.0251` | `+0.30%` |
| `LTC-USDT` | `52.66` | `53.19` | `50.6` | `+0.20%` |
| `QTUM-USDT` | `0.891` | `0.901` | `0.805` | `+4.33%` |
| `RVN-USDT` | `0.00339` | `0.00344` | `0.00316` | `+3.03%` |
| `SHIB-USDT` | `0.00000553` | `0.000005576` | `0.000005199` | `+0.61%` |
| `SOL-USDT` | `95.58` | `97.28` | `91.58` | `+2.10%` |
| `TRX-USDT` | `0.3443` | `0.3457` | `0.3419` | `-0.23%` |
| `UNI-USDT` | `4.6203` | `4.7066` | `4.0129` | `+7.11%` |
| `XLM-USDT` | `0.1999` | `0.202` | `0.1878` | `+1.78%` |
| `XMR-USDT` | `429.75` | `442.74` | `413.51` | `+0.27%` |
| `XRP-USDT` | `1.51969` | `1.55079` | `1.43457` | `+2.38%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-23 21:14:20 UTC"
}
```
