...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-19 00:50:10 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.1742` | `0.1769` | `0.1713` | `-0.22%` |
| `ALGO-USDT` | `0.0779` | `0.0784` | `0.0767` | `-0.38%` |
| `ATOM-USDT` | `1.4172` | `1.4799` | `1.3781` | `-0.01%` |
| `AVAX-USDT` | `6.344` | `6.455` | `6.237` | `-0.40%` |
| `BCH-USDT` | `202.98` | `205` | `202.62` | `-0.91%` |
| `BTC-USDT` | `64558.2` | `65050` | `64025.8` | `+0.27%` |
| `CAKE-USDT` | `1.518` | `1.53` | `1.453` | `+3.75%` |
| `DASH-USDT` | `29.73` | `30.52` | `29.69` | `-2.49%` |
| `DGB-USDT` | `0.003956` | `0.004167` | `0.003802` | `-1.56%` |
| `DOGE-USDT` | `0.07005` | `0.07055` | `0.0696` | `-0.32%` |
| `DOT-USDT` | `0.7514` | `0.7628` | `0.7237` | `-1.32%` |
| `ETC-USDT` | `6.0691` | `6.1856` | `6.0224` | `-1.88%` |
| `ETH-USDT` | `1915.11` | `1922.71` | `1885.75` | `+0.30%` |
| `LINK-USDT` | `9.5205` | `9.5586` | `9.3345` | `+0.44%` |
| `LTC-USDT` | `44.42` | `44.75` | `44.15` | `-0.42%` |
| `QTUM-USDT` | `0.682` | `0.696` | `0.674` | `+0.44%` |
| `RVN-USDT` | `0.00271` | `0.00276` | `0.00268` | `-1.81%` |
| `SHIB-USDT` | `0.000004427` | `0.000004477` | `0.000004361` | `-1.00%` |
| `SOL-USDT` | `77.05` | `77.4` | `75.22` | `+1.50%` |
| `TRX-USDT` | `0.3329` | `0.3396` | `0.3309` | `+0.45%` |
| `UNI-USDT` | `3.2933` | `3.3126` | `3.2303` | `+0.42%` |
| `XLM-USDT` | `0.1549` | `0.1577` | `0.1525` | `-1.71%` |
| `XMR-USDT` | `410.68` | `422.34` | `409` | `-1.00%` |
| `XRP-USDT` | `0.99803` | `1.00647` | `0.98911` | `-0.37%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-19 00:50:10 UTC"
}
```
