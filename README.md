...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-23 18:18:43 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.2249` | `0.2341` | `0.2133` | `-1.66%` |
| `ALGO-USDT` | `0.0939` | `0.0949` | `0.0879` | `+0.53%` |
| `ATOM-USDT` | `1.6158` | `1.6181` | `1.5194` | `+0.96%` |
| `AVAX-USDT` | `7.577` | `7.659` | `7.276` | `+0.01%` |
| `BCH-USDT` | `274.89` | `282.01` | `262.91` | `-2.21%` |
| `BTC-USDT` | `77339.8` | `77752.6` | `75558` | `+0.10%` |
| `CAKE-USDT` | `1.744` | `1.762` | `1.656` | `+1.92%` |
| `DASH-USDT` | `43.45` | `44.44` | `38.42` | `+2.79%` |
| `DGB-USDT` | `0.004807` | `0.0057` | `0.004148` | `+14.31%` |
| `DOGE-USDT` | `0.09304` | `0.09535` | `0.08875` | `-0.11%` |
| `DOT-USDT` | `0.927` | `0.938` | `0.8765` | `-0.72%` |
| `ETC-USDT` | `7.8783` | `8.0267` | `7.6278` | `-0.59%` |
| `ETH-USDT` | `2446.99` | `2484.76` | `2356.33` | `+0.79%` |
| `LINK-USDT` | `11.5541` | `11.8137` | `11.0251` | `-1.67%` |
| `LTC-USDT` | `52.37` | `53.71` | `50.6` | `-0.66%` |
| `QTUM-USDT` | `0.901` | `0.901` | `0.805` | `+5.62%` |
| `RVN-USDT` | `0.00335` | `0.00344` | `0.00316` | `+0.60%` |
| `SHIB-USDT` | `0.000005486` | `0.000005579` | `0.000005199` | `-1.04%` |
| `SOL-USDT` | `95.19` | `97.28` | `91.58` | `+1.02%` |
| `TRX-USDT` | `0.3438` | `0.3457` | `0.3419` | `-0.31%` |
| `UNI-USDT` | `4.5856` | `4.6626` | `4.0129` | `+7.50%` |
| `XLM-USDT` | `0.1997` | `0.202` | `0.1878` | `+0.70%` |
| `XMR-USDT` | `427.32` | `442.74` | `413.51` | `+1.46%` |
| `XRP-USDT` | `1.51111` | `1.55079` | `1.43457` | `+1.56%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-23 18:18:43 UTC"
}
```
