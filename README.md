...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-18 19:47:16 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.1742` | `0.1769` | `0.1713` | `+0.11%` |
| `ALGO-USDT` | `0.0781` | `0.0789` | `0.0767` | `-0.50%` |
| `ATOM-USDT` | `1.4293` | `1.4799` | `1.3781` | `+1.11%` |
| `AVAX-USDT` | `6.355` | `6.455` | `6.237` | `+0.12%` |
| `BCH-USDT` | `204.74` | `205.5` | `202.62` | `+0.26%` |
| `BTC-USDT` | `64681.1` | `65050` | `64025.8` | `+0.49%` |
| `CAKE-USDT` | `1.51` | `1.513` | `1.453` | `+2.86%` |
| `DASH-USDT` | `29.87` | `30.63` | `29.81` | `-1.64%` |
| `DGB-USDT` | `0.003934` | `0.004167` | `0.003802` | `-2.23%` |
| `DOGE-USDT` | `0.07041` | `0.07055` | `0.0696` | `+0.14%` |
| `DOT-USDT` | `0.7477` | `0.7649` | `0.7237` | `-1.69%` |
| `ETC-USDT` | `6.0813` | `6.1959` | `6.0224` | `-1.72%` |
| `ETH-USDT` | `1915.02` | `1922.71` | `1885.75` | `+0.29%` |
| `LINK-USDT` | `9.5013` | `9.5586` | `9.3345` | `+0.17%` |
| `LTC-USDT` | `44.57` | `44.75` | `44.15` | `+0.11%` |
| `QTUM-USDT` | `0.68` | `0.696` | `0.674` | `+0.00%` |
| `RVN-USDT` | `0.00271` | `0.00281` | `0.00271` | `-3.21%` |
| `SHIB-USDT` | `0.000004437` | `0.000004493` | `0.000004361` | `-0.64%` |
| `SOL-USDT` | `77.21` | `77.4` | `75.22` | `+1.75%` |
| `TRX-USDT` | `0.3332` | `0.3396` | `0.3309` | `+0.51%` |
| `UNI-USDT` | `3.2964` | `3.31` | `3.2303` | `+0.14%` |
| `XLM-USDT` | `0.1543` | `0.1583` | `0.1525` | `-2.21%` |
| `XMR-USDT` | `416.95` | `422.34` | `409` | `+1.26%` |
| `XRP-USDT` | `1.0024` | `1.00647` | `0.98911` | `+0.14%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-18 19:47:16 UTC"
}
```
