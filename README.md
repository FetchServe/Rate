...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-22 05:54:47 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.2318` | `0.2586` | `0.2066` | `+10.90%` |
| `ALGO-USDT` | `0.0966` | `0.1049` | `0.0891` | `+8.17%` |
| `ATOM-USDT` | `1.6213` | `1.72` | `1.5` | `+5.29%` |
| `AVAX-USDT` | `7.672` | `8.316` | `7.012` | `+4.08%` |
| `BCH-USDT` | `280.31` | `305.27` | `237.46` | `+16.69%` |
| `BTC-USDT` | `77258.1` | `79493.8` | `75109.5` | `+2.48%` |
| `CAKE-USDT` | `1.778` | `1.855` | `1.676` | `+6.08%` |
| `DASH-USDT` | `40.9` | `47.52` | `33.69` | `+21.00%` |
| `DGB-USDT` | `0.004437` | `0.004566` | `0.004111` | `+7.92%` |
| `DOGE-USDT` | `0.09099` | `0.10089` | `0.0826` | `+9.94%` |
| `DOT-USDT` | `0.9606` | `1.032` | `0.8478` | `+12.78%` |
| `ETC-USDT` | `8.1838` | `9.0904` | `7.062` | `+15.54%` |
| `ETH-USDT` | `2432.77` | `2547.38` | `2355.4` | `+3.02%` |
| `LINK-USDT` | `11.7833` | `12.604` | `10.9` | `+7.76%` |
| `LTC-USDT` | `51.81` | `74.14` | `48.51` | `+6.36%` |
| `QTUM-USDT` | `0.87` | `0.927` | `0.809` | `+7.54%` |
| `RVN-USDT` | `0.00361` | `0.00376` | `0.00308` | `+17.20%` |
| `SHIB-USDT` | `0.00000567` | `0.000006223` | `0.000005022` | `+12.83%` |
| `SOL-USDT` | `93.96` | `102.72` | `87.75` | `+3.84%` |
| `TRX-USDT` | `0.3458` | `0.3505` | `0.3381` | `+2.24%` |
| `UNI-USDT` | `4.1184` | `4.4464` | `3.738` | `+7.45%` |
| `XLM-USDT` | `0.2044` | `0.2225` | `0.1857` | `+9.48%` |
| `XMR-USDT` | `438.94` | `465.88` | `403.5` | `+4.69%` |
| `XRP-USDT` | `1.52203` | `1.69945` | `1.297` | `+15.95%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-22 05:54:47 UTC"
}
```
