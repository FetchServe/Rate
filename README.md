...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-22 06:27:26 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.2325` | `0.2586` | `0.2066` | `+10.81%` |
| `ALGO-USDT` | `0.0964` | `0.1049` | `0.0891` | `+7.58%` |
| `ATOM-USDT` | `1.6126` | `1.72` | `1.5` | `+4.67%` |
| `AVAX-USDT` | `7.65` | `8.316` | `7.012` | `+2.94%` |
| `BCH-USDT` | `279.64` | `305.27` | `247.2` | `+13.06%` |
| `BTC-USDT` | `77295.6` | `79493.8` | `75293.6` | `+2.49%` |
| `CAKE-USDT` | `1.773` | `1.855` | `1.676` | `+5.78%` |
| `DASH-USDT` | `41.17` | `47.52` | `33.73` | `+21.76%` |
| `DGB-USDT` | `0.004422` | `0.004566` | `0.004137` | `+6.73%` |
| `DOGE-USDT` | `0.09262` | `0.10089` | `0.0826` | `+10.74%` |
| `DOT-USDT` | `0.9596` | `1.032` | `0.8491` | `+12.82%` |
| `ETC-USDT` | `8.2489` | `9.0904` | `7.062` | `+16.47%` |
| `ETH-USDT` | `2432.78` | `2547.38` | `2356.2` | `+2.93%` |
| `LINK-USDT` | `11.8561` | `12.604` | `10.9` | `+7.70%` |
| `LTC-USDT` | `51.93` | `74.14` | `48.65` | `+6.61%` |
| `QTUM-USDT` | `0.861` | `0.927` | `0.811` | `+6.16%` |
| `RVN-USDT` | `0.00369` | `0.00376` | `0.00311` | `+17.89%` |
| `SHIB-USDT` | `0.00000565` | `0.000006223` | `0.000005041` | `+11.50%` |
| `SOL-USDT` | `94` | `102.72` | `87.75` | `+4.09%` |
| `TRX-USDT` | `0.3455` | `0.3505` | `0.3382` | `+2.12%` |
| `UNI-USDT` | `4.1477` | `4.4464` | `3.738` | `+8.34%` |
| `XLM-USDT` | `0.2102` | `0.2225` | `0.1857` | `+12.22%` |
| `XMR-USDT` | `431.48` | `465.88` | `403.5` | `+3.78%` |
| `XRP-USDT` | `1.5668` | `1.69945` | `1.297` | `+19.93%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-22 06:27:26 UTC"
}
```
