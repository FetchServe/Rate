...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-17 19:07:38 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.1741` | `0.1793` | `0.1725` | `-2.24%` |
| `ALGO-USDT` | `0.0785` | `0.0801` | `0.0774` | `-0.25%` |
| `ATOM-USDT` | `1.4122` | `1.4718` | `1.4071` | `-3.98%` |
| `AVAX-USDT` | `6.325` | `6.4` | `6.277` | `-0.29%` |
| `BCH-USDT` | `204.49` | `205.86` | `202.1` | `+0.29%` |
| `BTC-USDT` | `64358.7` | `64612.5` | `62715.9` | `+1.91%` |
| `CAKE-USDT` | `1.473` | `1.477` | `1.444` | `+1.02%` |
| `DASH-USDT` | `30.38` | `30.66` | `29.8` | `+0.82%` |
| `DGB-USDT` | `0.004037` | `0.004334` | `0.003956` | `-4.33%` |
| `DOGE-USDT` | `0.07035` | `0.07057` | `0.06901` | `+0.47%` |
| `DOT-USDT` | `0.76` | `0.7694` | `0.7531` | `-0.58%` |
| `ETC-USDT` | `6.2005` | `6.2371` | `6.0382` | `+0.51%` |
| `ETH-USDT` | `1908.16` | `1915.42` | `1869.4` | `+1.12%` |
| `LINK-USDT` | `9.4763` | `9.5761` | `9.3503` | `+0.49%` |
| `LTC-USDT` | `44.6` | `44.65` | `43.83` | `+0.15%` |
| `QTUM-USDT` | `0.68` | `0.687` | `0.671` | `-0.58%` |
| `RVN-USDT` | `0.00281` | `0.00317` | `0.00279` | `-2.09%` |
| `SHIB-USDT` | `0.000004472` | `0.000004518` | `0.000004372` | `+0.00%` |
| `SOL-USDT` | `75.83` | `76.22` | `74.1` | `+0.77%` |
| `TRX-USDT` | `0.3312` | `0.3349` | `0.3285` | `-0.18%` |
| `UNI-USDT` | `3.3027` | `3.3193` | `3.236` | `+0.02%` |
| `XLM-USDT` | `0.1579` | `0.1614` | `0.156` | `+0.25%` |
| `XMR-USDT` | `413.45` | `421.45` | `406.86` | `+0.73%` |
| `XRP-USDT` | `1.00111` | `1.00854` | `0.98835` | `+0.06%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-17 19:07:38 UTC"
}
```
