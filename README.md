...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-22 14:13:58 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.2255` | `0.2586` | `0.2066` | `+4.68%` |
| `ALGO-USDT` | `0.0928` | `0.1049` | `0.0915` | `-1.38%` |
| `ATOM-USDT` | `1.5884` | `1.72` | `1.5` | `+1.10%` |
| `AVAX-USDT` | `7.491` | `8.316` | `7.012` | `-0.97%` |
| `BCH-USDT` | `278.36` | `305.27` | `262.07` | `+2.94%` |
| `BTC-USDT` | `77071.6` | `78816.1` | `76486.5` | `+0.25%` |
| `CAKE-USDT` | `1.707` | `1.855` | `1.681` | `-0.69%` |
| `DASH-USDT` | `39.66` | `47.52` | `34.43` | `+12.89%` |
| `DGB-USDT` | `0.00416` | `0.004566` | `0.004001` | `-3.07%` |
| `DOGE-USDT` | `0.09101` | `0.10089` | `0.08293` | `+8.77%` |
| `DOT-USDT` | `0.927` | `1.032` | `0.8883` | `+3.72%` |
| `ETC-USDT` | `7.9066` | `9.0904` | `7.2996` | `+6.33%` |
| `ETH-USDT` | `2419.18` | `2547.38` | `2369.45` | `+1.57%` |
| `LINK-USDT` | `11.7619` | `12.604` | `10.9` | `+3.23%` |
| `LTC-USDT` | `51.91` | `55.42` | `50.18` | `+2.08%` |
| `QTUM-USDT` | `0.853` | `0.927` | `0.819` | `+1.06%` |
| `RVN-USDT` | `0.00335` | `0.00376` | `0.00329` | `+1.20%` |
| `SHIB-USDT` | `0.000005491` | `0.000006223` | `0.000005214` | `+4.53%` |
| `SOL-USDT` | `93.94` | `102.72` | `87.75` | `+3.25%` |
| `TRX-USDT` | `0.3435` | `0.3505` | `0.3387` | `+0.99%` |
| `UNI-USDT` | `4.2641` | `4.4464` | `3.738` | `+8.96%` |
| `XLM-USDT` | `0.2004` | `0.2225` | `0.1887` | `+4.48%` |
| `XMR-USDT` | `429.96` | `465.88` | `403.5` | `+3.28%` |
| `XRP-USDT` | `1.48972` | `1.69945` | `1.36227` | `+6.31%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-22 14:13:58 UTC"
}
```
