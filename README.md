...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-18 19:06:37 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.1745` | `0.1769` | `0.1713` | `+0.22%` |
| `ALGO-USDT` | `0.0783` | `0.0789` | `0.0767` | `-0.25%` |
| `ATOM-USDT` | `1.4318` | `1.4799` | `1.3781` | `+1.38%` |
| `AVAX-USDT` | `6.35` | `6.455` | `6.237` | `+0.26%` |
| `BCH-USDT` | `204.55` | `205.5` | `202.62` | `+0.02%` |
| `BTC-USDT` | `64753.9` | `65050` | `64025.8` | `+0.62%` |
| `CAKE-USDT` | `1.505` | `1.509` | `1.453` | `+2.17%` |
| `DASH-USDT` | `29.91` | `30.63` | `29.81` | `-1.67%` |
| `DGB-USDT` | `0.003946` | `0.004167` | `0.003802` | `-2.25%` |
| `DOGE-USDT` | `0.07053` | `0.07055` | `0.0696` | `+0.25%` |
| `DOT-USDT` | `0.7518` | `0.7649` | `0.7237` | `-1.02%` |
| `ETC-USDT` | `6.0977` | `6.2005` | `6.0224` | `-1.65%` |
| `ETH-USDT` | `1916.23` | `1922.71` | `1885.75` | `+0.42%` |
| `LINK-USDT` | `9.5125` | `9.5586` | `9.3345` | `+0.30%` |
| `LTC-USDT` | `44.5` | `44.75` | `44.15` | `-0.17%` |
| `QTUM-USDT` | `0.68` | `0.696` | `0.674` | `+0.00%` |
| `RVN-USDT` | `0.00273` | `0.00281` | `0.00271` | `-2.84%` |
| `SHIB-USDT` | `0.000004447` | `0.000004493` | `0.000004361` | `-0.58%` |
| `SOL-USDT` | `77.25` | `77.32` | `75.22` | `+1.83%` |
| `TRX-USDT` | `0.3336` | `0.3396` | `0.3309` | `+0.72%` |
| `UNI-USDT` | `3.2916` | `3.31` | `3.2303` | `-0.36%` |
| `XLM-USDT` | `0.1547` | `0.1583` | `0.1525` | `-2.02%` |
| `XMR-USDT` | `417.41` | `422.34` | `409` | `+1.01%` |
| `XRP-USDT` | `1.00119` | `1.00647` | `0.98911` | `+0.00%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-18 19:06:37 UTC"
}
```
