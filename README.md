...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-16 20:45:10 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.1778` | `0.1793` | `0.175` | `-0.16%` |
| `ALGO-USDT` | `0.0786` | `0.08` | `0.0785` | `-1.50%` |
| `ATOM-USDT` | `1.4637` | `1.5041` | `1.4616` | `-0.48%` |
| `AVAX-USDT` | `6.339` | `6.506` | `6.223` | `-2.53%` |
| `BCH-USDT` | `203.53` | `205.01` | `202.86` | `-0.03%` |
| `BTC-USDT` | `63057.5` | `63380.4` | `62957.9` | `-0.02%` |
| `CAKE-USDT` | `1.454` | `1.469` | `1.424` | `+1.46%` |
| `DASH-USDT` | `30.21` | `30.41` | `29.49` | `+0.66%` |
| `DGB-USDT` | `0.00419` | `0.004334` | `0.0039` | `+5.48%` |
| `DOGE-USDT` | `0.06995` | `0.07016` | `0.06952` | `+0.04%` |
| `DOT-USDT` | `0.7631` | `0.7688` | `0.756` | `-0.37%` |
| `ETC-USDT` | `6.169` | `6.2686` | `6.159` | `-1.35%` |
| `ETH-USDT` | `1883.33` | `1892.37` | `1877.12` | `+0.03%` |
| `LINK-USDT` | `9.4761` | `9.5985` | `9.2988` | `-1.20%` |
| `LTC-USDT` | `44.58` | `44.82` | `44.05` | `+0.92%` |
| `QTUM-USDT` | `0.684` | `0.685` | `0.67` | `+0.73%` |
| `RVN-USDT` | `0.00287` | `0.00287` | `0.0027` | `+2.86%` |
| `SHIB-USDT` | `0.000004462` | `0.000004555` | `0.000004459` | `-1.91%` |
| `SOL-USDT` | `75.15` | `75.72` | `75.05` | `-0.46%` |
| `TRX-USDT` | `0.3318` | `0.3327` | `0.3308` | `+0.09%` |
| `UNI-USDT` | `3.3039` | `3.3397` | `3.2174` | `+1.77%` |
| `XLM-USDT` | `0.1575` | `0.1597` | `0.1566` | `-0.19%` |
| `XMR-USDT` | `409.34` | `419.03` | `406.96` | `-0.85%` |
| `XRP-USDT` | `0.99983` | `1.0065` | `0.99733` | `-0.40%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-16 20:45:10 UTC"
}
```
