...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-25 19:53:48 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.214` | `0.2289` | `0.2115` | `-2.01%` |
| `ALGO-USDT` | `0.0904` | `0.0954` | `0.0898` | `-1.52%` |
| `ATOM-USDT` | `1.5427` | `1.5646` | `1.5088` | `+0.50%` |
| `AVAX-USDT` | `7.468` | `7.733` | `7.327` | `-0.65%` |
| `BCH-USDT` | `266.36` | `281.7` | `265.4` | `-1.11%` |
| `BTC-USDT` | `78930.6` | `81269.4` | `78124.7` | `+0.41%` |
| `CAKE-USDT` | `1.731` | `1.802` | `1.713` | `-1.08%` |
| `DASH-USDT` | `39.53` | `43.94` | `39.4` | `-4.19%` |
| `DGB-USDT` | `0.00495` | `0.005264` | `0.004757` | `+3.12%` |
| `DOGE-USDT` | `0.08814` | `0.09308` | `0.087` | `-0.84%` |
| `DOT-USDT` | `0.8763` | `0.9241` | `0.8644` | `-2.94%` |
| `ETC-USDT` | `7.7709` | `8.0992` | `7.6957` | `+0.37%` |
| `ETH-USDT` | `2461.95` | `2532` | `2439.65` | `-0.14%` |
| `LINK-USDT` | `11.476` | `11.9608` | `11.3648` | `-0.37%` |
| `LTC-USDT` | `50.84` | `52.98` | `50.32` | `-1.31%` |
| `QTUM-USDT` | `0.863` | `0.891` | `0.859` | `-1.14%` |
| `RVN-USDT` | `0.00323` | `0.00339` | `0.00323` | `-1.82%` |
| `SHIB-USDT` | `0.000005388` | `0.00000575` | `0.00000535` | `-0.86%` |
| `SOL-USDT` | `97.86` | `103` | `95.76` | `+1.74%` |
| `TRX-USDT` | `0.3388` | `0.3467` | `0.3383` | `-1.42%` |
| `UNI-USDT` | `4.3165` | `4.4745` | `4.2443` | `+1.31%` |
| `XLM-USDT` | `0.1888` | `0.2002` | `0.1881` | `-1.76%` |
| `XMR-USDT` | `438.55` | `454.29` | `434.2` | `-0.80%` |
| `XRP-USDT` | `1.46942` | `1.55` | `1.44399` | `+0.00%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-25 19:53:48 UTC"
}
```
