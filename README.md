...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-15 20:13:55 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.1779` | `0.1817` | `0.177` | `-1.11%` |
| `ALGO-USDT` | `0.0799` | `0.0803` | `0.0788` | `+0.75%` |
| `ATOM-USDT` | `1.4738` | `1.5136` | `1.4638` | `-0.18%` |
| `AVAX-USDT` | `6.501` | `6.876` | `6.391` | `+1.07%` |
| `BCH-USDT` | `203.49` | `206.97` | `202.88` | `+0.08%` |
| `BTC-USDT` | `63073` | `63180` | `62801.6` | `+0.11%` |
| `CAKE-USDT` | `1.435` | `1.439` | `1.416` | `+1.34%` |
| `DASH-USDT` | `30.03` | `30.23` | `29.78` | `+0.16%` |
| `DGB-USDT` | `0.003972` | `0.004234` | `0.00387` | `-2.02%` |
| `DOGE-USDT` | `0.06992` | `0.07053` | `0.06968` | `+0.08%` |
| `DOT-USDT` | `0.7672` | `0.7842` | `0.7517` | `+1.25%` |
| `ETC-USDT` | `6.2597` | `6.2885` | `6.148` | `+1.49%` |
| `ETH-USDT` | `1883.55` | `1886.72` | `1875.9` | `+0.18%` |
| `LINK-USDT` | `9.5685` | `9.7467` | `8.9273` | `+6.49%` |
| `LTC-USDT` | `44.19` | `44.33` | `43.52` | `+1.26%` |
| `QTUM-USDT` | `0.676` | `0.698` | `0.673` | `-3.15%` |
| `RVN-USDT` | `0.0028` | `0.0028` | `0.00262` | `+6.06%` |
| `SHIB-USDT` | `0.000004548` | `0.000004641` | `0.000004527` | `-0.59%` |
| `SOL-USDT` | `75.52` | `75.71` | `74.98` | `+0.54%` |
| `TRX-USDT` | `0.3316` | `0.3393` | `0.3309` | `-0.42%` |
| `UNI-USDT` | `3.2428` | `3.3134` | `3.1799` | `+1.27%` |
| `XLM-USDT` | `0.1579` | `0.1598` | `0.1554` | `-0.75%` |
| `XMR-USDT` | `413.13` | `413.47` | `394.34` | `+3.89%` |
| `XRP-USDT` | `1.00374` | `1.00778` | `0.98677` | `+0.50%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-15 20:13:55 UTC"
}
```
