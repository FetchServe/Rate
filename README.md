...
:zap: Source : KuCoin public API &nbsp;|&nbsp; Pairs : `24` &nbsp;|&nbsp; Updated : `2026-08-17 00:51:55 UTC`

---

| Pair | Last Price | High 24h | Low 24h | Change 24h |
|:-----|-----------:|---------:|--------:|-----------:|
| `ADA-USDT` | `0.1754` | `0.1793` | `0.1739` | `-0.73%` |
| `ALGO-USDT` | `0.0785` | `0.0798` | `0.0774` | `-1.62%` |
| `ATOM-USDT` | `1.4545` | `1.5041` | `1.4496` | `-1.62%` |
| `AVAX-USDT` | `6.303` | `6.437` | `6.277` | `-0.34%` |
| `BCH-USDT` | `203.94` | `205.01` | `202.1` | `+0.22%` |
| `BTC-USDT` | `62853.1` | `63380.4` | `62715.9` | `-0.34%` |
| `CAKE-USDT` | `1.451` | `1.469` | `1.424` | `+1.61%` |
| `DASH-USDT` | `29.97` | `30.41` | `29.49` | `+0.90%` |
| `DGB-USDT` | `0.004154` | `0.004334` | `0.003906` | `+5.37%` |
| `DOGE-USDT` | `0.06964` | `0.07016` | `0.06901` | `-0.01%` |
| `DOT-USDT` | `0.7615` | `0.7688` | `0.7531` | `+0.25%` |
| `ETC-USDT` | `6.1472` | `6.2215` | `6.0382` | `-1.19%` |
| `ETH-USDT` | `1875.29` | `1892.37` | `1869.4` | `-0.35%` |
| `LINK-USDT` | `9.3974` | `9.5123` | `9.2988` | `-0.38%` |
| `LTC-USDT` | `44.12` | `44.82` | `44.04` | `-0.02%` |
| `QTUM-USDT` | `0.671` | `0.685` | `0.67` | `-0.59%` |
| `RVN-USDT` | `0.00295` | `0.00299` | `0.0027` | `+6.11%` |
| `SHIB-USDT` | `0.000004404` | `0.000004527` | `0.000004372` | `-2.52%` |
| `SOL-USDT` | `74.58` | `75.71` | `74.1` | `-1.12%` |
| `TRX-USDT` | `0.3313` | `0.3327` | `0.3308` | `+0.06%` |
| `UNI-USDT` | `3.2605` | `3.3397` | `3.2174` | `+0.44%` |
| `XLM-USDT` | `0.1561` | `0.1597` | `0.156` | `-0.88%` |
| `XMR-USDT` | `410.4` | `419.03` | `406.86` | `+0.11%` |
| `XRP-USDT` | `0.99091` | `1.00359` | `0.98835` | `-1.09%` |
...
```json
{
    ...
    "lowPrice24h": "62480.1",
    "changeRate": "0.0049",
    "lastUpdated": "2026-08-17 00:51:55 UTC"
}
```
